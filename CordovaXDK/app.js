...
var fb = new Firebase("https://sweltering-torch-9662.firebaseio.com/");
...
messages.limitToLast(100).on("child_added", function(snap) {
	wrap.append('<li><img id="" src="01.jpg" class="avatar"></img><span>' + $.sanitize(snap.val().user) + ':</span> ' + $.sanitize(snap.val().message) + '</li>');
